...
your results to the first 5 records. 
...
BETWEEN '1990-01-01' AND '1999-12-31' ORDER BY hire_date LIMIT 5;
-- -------------------------------4---------------------------------------
/*Try to think of your results as batches, sets, or pages. The first five results 
are your first page. 
